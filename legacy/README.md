...
```bash
python -m reclaim scrape <aistudio|deepseek|kimi|chatgpt>
```

| File | What it was |
|---|---|
| `scrape_googleaistudio.py` | AI Studio RPC replay scraper (v2, single-file). Superseded by `reclaim/providers/aistudio.py` |
